                ...
                <div className={'flex justify-center sm:justify-between flex-wrap'}>
                    ...
                    <RoomCard
                        ...
                        modalText={
                            <>
                                <p>
                                    Самый комфортабельный двухместный номер с очень большим балконом, выходящим в две
                                    стороны отеля. Вы сможете увидеть и рассвет и закат. На балконе есть стол и стулья,
                                    а так же сушилка для белья. Очень широкая двуспальная кровать (не раздвигается).
                                    Ванная комната больших размеров, в которой есть и душевая кабинка и ванна. В номере
                                    есть фен, мини холодильник, телевизор, кондиционер, вентилятор, чайник, набор чашек,
                                    питьевая вода, чай и кофе, фирменное пляжное полотенце, шкаф, сейф.
                                </p>
                                <p>В этом номере подселение третьего человека не предусмотрено. Прекрасно подойдет для
                                    молодоженов.</p>
                                <p><u>Стоимость номера в сутки с завтраком при групповом заезде:</u></p>
                                <p>Одноместное размещение - <span>90$</span></p>
                                <p>Двухместное размещение - <span>110$</span></p>
                                <p>Доплата за ужин или обед (шведский стол) по <span>12$</span> на человека (по желанию)
                                </p>
                                <p>Трансфер из аэропорта на собственном катере в обе стороны <span>70$</span> за
                                    человека</p>
